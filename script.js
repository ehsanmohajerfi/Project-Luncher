...
const translations = {
  en: {
    ...
    '.work-heading .kicker': '02 / SELECTED WORK', '.work-heading h2': 'Ideas made<br><span>useful and real.</span>', '.work-heading>a': 'View all projects ↗', '.work-card-live .work-index span:last-child': 'RESTAURANT · LIVE PROJECT', '.work-card-live .work-content>p': 'A modern restaurant website and ordering system for Viitasaari, Finland, with real-time order tracking, reservations and a bilingual experience.', '.work-card-live .work-content ul': '<li>Real-time order tracking and staff dashboards</li><li>Reservation flow with email verification</li><li>Finnish and English user experience</li>', '.work-card:not(.work-card-live) .work-index span:last-child': 'TOURISM · IN DEVELOPMENT', '.work-card:not(.work-card-live) .work-content>p': 'A digital tourism experience connecting Central Finland’s local businesses, stories and travellers through AI-assisted discovery and smart itinerary planning.', '.work-card:not(.work-card-live) .work-content ul': '<li>Experience design and content strategy</li><li>AI-guided exploration prototype</li><li>Research and stakeholder interviews</li>', '.clients-section .kicker': 'CLIENTS & COLLABORATORS', '.clients-section h2': 'Trusted by local businesses<br>in Central Finland.',
    '.expectations-section>.kicker': 'WHAT YOU CAN EXPECT', '.expectations-section>h2': 'A collaboration built<br><span>around clarity.</span>', '.testimonial-note': 'Client testimonials will be added here only with verified quotes and permission.',
    '.approach .kicker': '03 / THE APPROACH', '.approach-line': '<span>Design-minded.</span><span>Engineering-led.</span><span>Business-aware.</span>', '.principles': '<p><b>01</b> Clear communication</p><p><b>02</b> Purposeful design</p><p><b>03</b> Reliable delivery</p>',
    '.contact-heading .kicker': '04 / GET IN TOUCH', '.contact-heading h2': 'Have a project in mind?<br><span>Let’s talk.</span>', '.contact-heading>p:last-child': 'Send a short callback request and I’ll get back to you as soon as possible.',
    ...
    '.work-heading .kicker': '02 / VALITUT TYÖT', '.work-heading h2': 'Ideoista syntyy<br><span>hyödyllisiä ratkaisuja.</span>', '.work-heading>a': 'Katso kaikki projektit ↗', '.work-card-live .work-index span:last-child': 'RAVINTOLA · JULKAISTU PROJEKTI', '.work-card-live .work-content>p': 'Moderni ravintolasivusto ja tilausjärjestelmä Viitasaarelle, reaaliaikaisella tilausseurannalla, varauksilla ja kaksikielisellä käyttökokemuksella.', '.work-card-live .work-content ul': '<li>Reaaliaikainen tilausseuranta ja henkilökunnan hallintapaneeli</li><li>Varausprosessi sähköpostivahvistuksella</li><li>Suomen- ja englanninkielinen käyttökokemus</li>', '.work-card:not(.work-card-live) .work-index span:last-child': 'MATKAILU · KEHITYKSESSÄ', '.work-card:not(.work-card-live) .work-content>p': 'Keski-Suomen yrityksiä, tarinoita ja matkailijoita yhdistävä digitaalinen matkailukokemus, jossa hyödynnetään tekoälyä ja älykästä reittisuunnittelua.', '.work-card:not(.work-card-live) .work-content ul': '<li>Palvelumuotoilu ja sisältöstrategia</li><li>Tekoälyohjatun tutkimisen prototyyppi</li><li>Tutkimus ja sidosryhmähaastattelut</li>', '.clients-section .kicker': 'ASIAKKAAT & YHTEISTYÖKUMPPANIT', '.clients-section h2': 'Keski-Suomen paikallisten<br>yritysten luottama.',
    '.expectations-section>.kicker': 'MITÄ VOIT ODOTTAA', '.expectations-section>h2': 'Yhteistyö rakentuu<br><span>selkeyden ympärille.</span>', '.testimonial-note': 'Asiakaspalautteet lisätään vain vahvistettuina ja luvalla.',
    '.approach .kicker': '03 / TOIMINTATAPA', '.approach-line': '<span>Muotoilutietoinen.</span><span>Tekniikkalähtöinen.</span><span>Liiketoimintaa ymmärtävä.</span>', '.principles': '<p><b>01</b> Selkeä viestintä</p><p><b>02</b> Tarkoituksenmukainen design</p><p><b>03</b> Luotettava toimitus</p>',
    '.contact-heading .kicker': '04 / OTA YHTEYTTÄ', '.contact-heading h2': 'Onko sinulla projekti mielessä?<br><span>Jutellaan.</span>', '.contact-heading>p:last-child': 'Lähetä lyhyt yhteydenottopyyntö, niin vastaan mahdollisimman pian.',
  ...
  fa: {
    ...
    '.work-heading .kicker': '۰۲ / پروژه‌های منتخب', '.work-heading h2': 'ایده‌هایی که<br><span>واقعی و کاربردی شدند.</span>', '.work-heading>a': 'مشاهده همه پروژه‌ها ↗', '.work-card-live .work-index span:last-child': 'رستوران · پروژه منتشرشده', '.work-card-live .work-content>p': 'وب‌سایت و سیستم سفارش مدرن برای یک رستوران در ویتاساری فنلاند، همراه با رهگیری لحظه‌ای سفارش، رزرو و رابط دوزبانه.', '.work-card-live .work-content ul': '<li>رهگیری لحظه‌ای سفارش و داشبورد کارکنان</li><li>رزرو با تأیید ایمیل</li><li>تجربه کاربری فنلاندی و انگلیسی</li>', '.work-card:not(.work-card-live) .work-index span:last-child': 'گردشگری · در حال توسعه', '.work-card:not(.work-card-live) .work-content>p': 'تجربه گردشگری دیجیتال برای ارتباط کسب‌وکارهای محلی، داستان‌ها و مسافران فنلاند مرکزی با جست‌وجوی هوشمند و برنامه‌ریزی سفر.', '.work-card:not(.work-card-live) .work-content ul': '<li>طراحی تجربه و استراتژی محتوا</li><li>نمونه اولیه گردش با راهنمای هوش مصنوعی</li><li>تحقیق و مصاحبه با ذی‌نفعان</li>', '.clients-section .kicker': 'مشتریان و همکاران', '.clients-section h2': 'مورد اعتماد کسب‌وکارهای محلی<br>در فنلاند مرکزی.',
    '.expectations-section>.kicker': 'چه انتظاری می‌توانید داشته باشید', '.expectations-section>h2': 'همکاری بر پایه<br><span>شفافیت.</span>', '.testimonial-note': 'دیدگاه مشتریان فقط با نقل‌قول تأییدشده و اجازه آن‌ها اضافه می‌شود.',
    '.approach .kicker': '۰۳ / شیوه همکاری', '.approach-line': '<span>نگاه طراحی.</span><span>مهندسی‌محور.</span><span>آشنا با کسب‌وکار.</span>', '.principles': '<p><b>۰۱</b> ارتباط شفاف</p><p><b>۰۲</b> طراحی هدفمند</p><p><b>۰۳</b> تحویل قابل اعتماد</p>',
    '.contact-heading .kicker': '۰۴ / ارتباط با من', '.contact-heading h2': 'پروژه‌ای در ذهن دارید؟<br><span>گفت‌وگو کنیم.</span>', '.contact-heading>p:last-child': 'یک درخواست کوتاه ارسال کنید تا در اولین فرصت با شما تماس بگیرم.',
